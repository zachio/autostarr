...
import Rover from './old/Rover'
import SpaceShip from './old/SpaceShip'
import Star from './old/Star'
import Area from './old/Area'
import Planet from './old/Planet'
import StarSystem from './old/StarSystem'
...
let app = new Vue({
    ...
    methods: {
      ...
      reset() {
        ...
        this.player = new Player(1, [starId, astroId+1, areaId])
